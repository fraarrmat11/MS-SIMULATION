package com.gft.simulation.clock.integration;

import com.gft.simulation.clock.internal.infrastructure.config.ClockRabbitMQConfig;
import com.gft.simulation.clock.internal.infrastructure.persistence.jpa.SpringDataSimulationClockRepository;
...
class RabbitMQPublishingIT {
    ...
    void advanceTime_publishesMessageToQueue() throws Exception {
        ...
        Message message = rabbitTemplate.receive(ClockRabbitMQConfig.TIME_ADVANCED_QUEUE, 5000);
    ...
    void twoTicks_publishesTwoMessagesWithAccumulatedDays() throws Exception {
        ...
        Message first  = rabbitTemplate.receive(ClockRabbitMQConfig.TIME_ADVANCED_QUEUE, 5000);
        Message second = rabbitTemplate.receive(ClockRabbitMQConfig.TIME_ADVANCED_QUEUE, 5000);
